...
RESULTS_DIR = "results/case2015"
GAMS_MODEL_PATH = "src/gams_model_case2015.gms"
...
CASES_TO_RUN = [
    {
        "file": "C9.csv", 
        "start_date": "2015-03-23", "start_time": "11:30", 
        "n_val": 9, "total_n": 9, "f_val": 1, "sample_id": 1
    },
    {
        "file": "S9.csv", 
        "start_date": "2015-04-19", "start_time": "10:15",
        "n_val": 9, "total_n": 9, "f_val": 1, "sample_id": 2
    },
    {
        "file": "E8.csv", 
        "start_date": "2015-04-01", "start_time": "13:00",
        "n_val": 8, "total_n": 8, "f_val": 1, "sample_id": 3
    }
]
...
def run_gams_scenario(n_val, total_n, sample_id, f_val, start_date, start_time, reslim, optcr, file_path, file_name):
    n_str = f"{n_val:02d}"
    ...
    print(f"\n==================================================")
    print(f"Running Case Study: {file_name} (N={n_val}, Sample={sample_id})")
    print(f"==================================================")
    
    list_file_path = os.path.join(RESULTS_DIR, f"run_{file_name}_S{sample_id_str}.lst")
    log_file_path = os.path.join(RESULTS_DIR, f"run_{file_name}_S{sample_id_str}.log")
...
def main():
    ...
    file_path_segment = "/case2015"

    for case in CASES_TO_RUN:
        file_name_segment = os.path.splitext(case["file"])[0]
        run_gams_scenario(
            n_val=case["n_val"],
